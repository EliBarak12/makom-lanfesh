export const dataHebrew ={
    getSupport: {
      ...
      questionnaire: {
        header: 'מקום לנפש',
        prefix: 'בשבוע האחרון עד כמה הפריעו לך:',
        selections: {
          '0': 'כלל לא - 0',
          '1': 'במידה מועטה - 1',
          '2': 'באופן בינוני - 2',
  ...
  אם אתה מרגיש שאתה עלול לפגוע בעצמך או באחרים לחץ על כפתור 'ערוצי התמיכה'.  אם אתה מרגיש במצוקה או מתח, אתה מוזמן להשתמש באחד מהכלים האחרים שבתוך היישומון או להיכנס לסולי הבוטית שב'ארגז הכלים'   במידה ותהיה/י מעוניין/ת בהתאמה לערוץ תמיכה מסויים או לשאלות נוספות את/ה מוזמן/ת לפנות למרכז הירושלמי בטלפון 0506262010 בין השעות 9:00-16:00 ימים א'-ה', או בוואטסאפ, ואנחנו נחזור אליך בהקדם..
  ...
  מומלץ לבצע הערכה פעם בשבוע, על מנת לעקוב אחר השינויים, ובתקווה לראות שיפור עם הזמן.   במידה ותהיה/י מעוניין/ת בהתאמה לערוץ תמיכה מסויים או לשאלות נוספות את/ה מוזמן/ת לפנות למרכז הירושלמי בטלפון 0506262010 בין השעות 9:00-16:00 ימים א'-ה', או בוואטסאפ, ואנחנו נחזור אליך בהקדם.`,
  ...
  מומלץ לבצע הערכה פעם בשבוע, על מנת לעקוב אחר השינויים, ובתקווה לראות שיפור עם הזמן.`,
      ...
      findProCare: {
        ...
        healthFundsTitle: `קופות החולים מעניקות 3 מפגשים טלפוניים ללא עלות עם איש מקצוע בתחום בריאות הנפש. ניתן לתאם באותם מספרי של מוקדי החירום הנ"ל    במידה ותהיה/י מעוניין/ת בהתאמה לערוץ תמיכה מסויים או לשאלות נוספות את/ה מוזמן/ת לפנות למרכז הירושלמי בטלפון 0506262010 בין השעות 9:00-16:00 ימים א'-ה', או בוואטסאפ, ואנחנו נחזור אליך בהקדם.`,
